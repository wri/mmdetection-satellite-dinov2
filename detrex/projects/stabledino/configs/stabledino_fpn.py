...
from .models.stabledino_ssl_fpn import model
...
train.init_checkpoint = None#"/home/ubuntu/mmdetection/models/SSLLarge.pth"
...
#def my_factor_func 
optimizer.params.lr_factor_func = lambda module_name: 0.1 if 'backbone' in module_name and 'fpn' not in module_name else 1 #any(module_name in ["backbone.blocks", "backbone.norm", "backbone.pos_embed", "backbone.dist_token", "backbone.patch_embed"]) else 1
optimizer.params.overrides = {'backbone': {'weight_decay': 0.01},
                                    #'backbone.norm': {'lr_mult':0.1, 'lr_factor' : 0.1, 'weight_decay' : 0.01},
                                    'backbone.backbone.blocks': {'lr_mult':0.1, 'lr_factor' : 0.1, 'weight_decay' : 0.01},
                                    ...
                                    'mask_token': {'lr':0.0},
                                    'backbone.patch_embed': {'lr_mult':0.1, 'lr_factor' : 0.1, 'weight_decay' : 0.01},
                                   }
