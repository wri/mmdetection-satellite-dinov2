...
# python tools/train_net.py --config-file projects/stabledino/configs/stabledino_vit.py     --num-gpus 1     dataloader.train.total_batch_size=2     train.output_dir="./output/stabledino_vit"     train.test_with_nms=0.2
